import 'package:edobra/app/modules/seguranca/controllers/seguranca_controller.dart';
import 'package:edobra/app/routes/app_routes.dart';
import 'package:edobra/app/widgets/text_input_widget.dart';
              ...
              child: Column(
                children: [
                  ...
                  TextInputWidget(
                      ...
                      'Número da Conta',
                      (value) => controller.pessoa.nConta.length < 8
                          ? 'Número da Conta tem no minimo 8 digitos'
                          : null,
                      TextInputType.number, (value) {
                    controller.pessoa.nConta = value;
                  }),
                  SizedBox(
                    height: 20,
                  ),
                  ...
                  TextInputWidget(
                      ...
                      'Nif',
                      (value) => controller.pessoa.nif.length < 9
                          ? 'Nif deve ter no minimo 9 caracteres'
                          : null,
                      TextInputType.number, (value) {
                    controller.pessoa.nif = value;
                  }),
                  SizedBox(
                    height: 20,
                  ),
