...
class EnviarPage extends GetView<EnviarController> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      drawer: CustomDrawer(),
      appBar: AppBar(
        title: 'Envio'.text.size(20).semiBold.color(Color(0xFF495157)).make(),
        centerTitle: true,
      ),
      body: Container(
        ...
        child: ListView(
          children: [
            ...
            'Seu Contactos'
                ...
                .size(16)
                .make(),
            GetBuilder<EnviarController>(builder: (_) {
              return controller
                          .favorito
                  ? Container(
                      height: 212,
                      ...
                      decoration: ShapeDecoration(
                        shape: RoundedRectangleBorder(
                            ...
                            side: BorderSide(
                                width: 0.1, color: Color(0xFF3B3A3A))),
                      ),
                      child: Column(
                        ...
                        children: [
                          ...
                          'Favoritos'
                              ...
                              .size(18)
                              .make(),
                          GetBuilder<EnviarController>(
                            builder: (_) {
                              return Column(
                                children: controller.contactosResumo
                                    .map((e) => e.favorito
                                        ? TileContatoWidget(
                                            e, 'Enviar', Color(0xFF2B419C))
                                        : Container())
                                    .toList(),
                              );
                            },
            ...
            GetBuilder<EnviarController>(
              builder: (_) {
                return Column(
                  children: controller.contactosResumo
                      .map((e) =>
                          TileContatoWidget(e, 'Enviar', Color(0xFF2B419C)))
                      .toList(),
                );
              },
            ),
